                            ...
                            <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        ...
                                        <?php echo form_error('nama', '<div class="text-danger small text-left ml-1">','</div>'); ?>
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        ...
                                        <?php echo form_error('username', '<div class="text-danger small text-left ml-1">','</div>'); ?>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            ...
                                            <?php echo form_error('password_1', '<div class="text-danger small text-left ml-1">','</div>'); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            ...
                                            <?php echo form_error('password_2', '<div class="text-danger small text-left ml-1">','</div>'); ?>
